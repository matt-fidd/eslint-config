/* eslint-disable multiline-comment-style, comma-dangle */
...
module.exports = {
	...
	// information cacheDirectory: '/tmp/jest_2s',

	// Automatically clear mock calls, instances and results before every
	...
	// coverage information should be collected collectCoverageFrom:
	// undefined,
	...
	// reports coverageReporters: [ 'json', 'text', 'lcov', 'clover' ],

	// An object that configures minimum threshold enforcement for coverage
	// results coverageThreshold: undefined,

	// A path to a custom dependency extractor dependencyExtractor:
	// undefined,
	...
	// A path to a module which exports an async function that is triggered
	// once after all test suites globalTeardown: undefined,
	...
	// use a maximum of 2 workers.  maxWorkers: '50%',
	...
	// An array of file extensions your modules use moduleFileExtensions: [
	...
	// A preset that is used as a base for Jest's configuration preset:
	// undefined,
	...
	// Automatically restore mock state and implementation before every
	// test restoreMocks: false,

	// The root directory that Jest should scan for tests and modules
	// within rootDir: undefined,

	// A list of paths to directories that Jest should use to search for
	// files in roots: [ '<rootDir>' ],

	// Allows you to use a custom runner instead of Jest's default test
	// runner runner: 'jest-runner',

	// The paths to modules that run some code to configure or set up the
	// testing environment before each test setupFiles: [],
	...
	// The test environment that will be used for testing testEnvironment:
	...
	// The glob patterns Jest uses to detect test files testMatch: [
	...
	// in properties such as location.href testURL: 'http://localhost',

	// Setting this value to 'fake' allows the use of fake timers for
	// functions such as 'setTimeout' timers: 'real',

	// A map from regular expressions to paths to transformers transform:
	// undefined,
	...
	// run verbose: undefined,

	// An array of regexp patterns that are matched against all source file
	// paths before re-running tests in watch mode watchPathIgnorePatterns:
	// [],
